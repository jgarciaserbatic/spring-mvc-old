...
public class ProfersoresServiceImpl implements ProfesoresService {
	...
	public List<ProfesoresDto> findAll() {
		...
		for(Profesores alumno: found) {
			result.add(modelMapper.map(alumno, ProfesoresDto.class));
		}
		return result;
	}
