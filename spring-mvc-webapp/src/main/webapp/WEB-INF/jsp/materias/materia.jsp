...
<form:form modelAttribute="materias" action="${ url }" >
	
	<h1>${ title }</h1>
	<form:hidden path="id"/>
	<spring:message code="materias.nombre"></spring:message>: <form:input path="nombre" /><br/>
	<spring:message code="materias.fechaexamen"></spring:message><form:input path="fechaExamen"/><br/> Fecha  formato: dd/mm/yyyy
