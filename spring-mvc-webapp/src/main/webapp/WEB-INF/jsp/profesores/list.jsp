...
<h1><spring:message code="profesor.h1.listado"></spring:message>:</h1>
<br>
...
<table>
	...
	<tbody>
		...
		<c:forEach items="${ profesores }" var="profesor">
			<tr>
				...
				<td><a
					href="<spring:url value="/profesores/delete/${ profesor.id }" ></spring:url>">Eliminar</a>
					<a
					href="<spring:url value="/profesores/update/${ profesor.id }" ></spring:url>">Actualizar</a>
				</td>
	...
	<form:form action="${ url }">
		<button type="submit">
			<spring:message code="profesores.options.add"></spring:message>
		</button>
	</form:form>
